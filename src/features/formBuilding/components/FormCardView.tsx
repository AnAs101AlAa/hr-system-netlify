        ...
        displayedForms.map((form, index) => (
          <div key={form.id || index} className="p-4 space-y-3">
            <div className="flex justify-between items-start">
              <div>
                <p className="font-medium text-inactive-tab-text dark:text-text-muted-foreground text-[16px] md:text-[18px]">
                  {form.title || "N/A"}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm mt-4">
              <div>
                ...
                <p className="text-dashboard-card-text dark:text-text-body-main">
