...
export default function FilterModal({isOpen, onClose, searchParams}: {isOpen: boolean, onClose: () => void, searchParams: FilterSearchParams}) {
    ...
    const [localDepartmentKey, setLocalDepartmentKey] = useState(searchParams.departmentKey);
        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Filter Teams">
            <div className="space-y-5 mt-2 w-full">
                <div className="w-full">
                    <p className="lg:text-[16px] md:text-[15px] text-[14px] font-medium mb-2">Department</p>
                    <DropdownMenu
                        placeholder="Select Department"
                        options={[{label: "All Departments", value: ""}, ...DEPARTMENT_LIST]}
                        value={localDepartmentKey}
                        onChange={(value) => setLocalDepartmentKey(value)}
                    />
                </div>
                <div className="w-full">
                    <p className="lg:text-[16px] md:text-[15px] text-[14px] font-medium mb-2">Team Name</p>
                    <SearchField 
                        className="lg:w-full"
                ...
                <div className="w-full">
                    <p className="lg:text-[16px] md:text-[15px] text-[14px] font-medium mb-2">Team Code</p>
                    <SearchField 
                        className="lg:w-full"
                ...
                <div className="w-full">
                    <p className="lg:text-[16px] md:text-[15px] text-[14px] font-medium mb-2">Course</p>
                    <SearchField 
                        className="lg:w-full"
