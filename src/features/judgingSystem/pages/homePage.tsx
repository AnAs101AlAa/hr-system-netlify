    ...
    return (
        <WithNavbar>
            <div className="min-h-screen bg-background p-4 w-[96%] md:w-[94%] lg:w-[84%] xl:w-[73%] mx-auto">
                ...
                <Activity mode={activeTab === "teams" ? "visible" : "hidden"}>
                    <TeamsAdminPage event={event} />
                </Activity>
                <Activity mode={activeTab === "questions" ? "visible" : "hidden"}>
                    <div className="text-center text-primary font-semibold mt-10">Question management coming soon!</div>
                </Activity>
            </div>
        </WithNavbar>
    );
