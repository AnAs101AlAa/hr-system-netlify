...
export default function TeamsPage({event, mode} : {event: Event | undefined, mode: boolean}) {
    ...
    return (
        <>
            <LogoutModal showLogoutModal={isLogoutModalOpen} setShowLogoutModal={() => setIsLogoutModalOpen(false)} />
            ...
            <div className="w-full space-y-3">
                <div className="flex justify-between items-center gap-5">
                    ...
                    {!mode && <Button buttonText="Log out" onClick={() => setIsLogoutModalOpen(true)} type="basic" width="auto" buttonIcon={<BiLogOut className="size-4" />} />}
                    {mode && <Button buttonText="New Team" onClick={handleOpenCreateModal} type="primary" width="auto" buttonIcon={<FaPlus />} />}
                </div>
