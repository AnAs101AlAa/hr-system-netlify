...
export default function LateArrivalPopup({
  isPopupOpen,
  onPopupClose,
}: {
  isPopupOpen: boolean;
  ...
  return (
    <Modal title="Late Arrival Notice" isOpen={isPopupOpen} onClose={handleCancel}>
      <div className="p-4 sm:p-6 md:p-8 space-y-4">
        <p className="text-base sm:text-lg md:text-xl font-medium mb-2">
          Please provide the reason for late arrival
        </p>
        <TextAreaField
          id="Late Arrival Reasoning"
          label="Reason"
          value={reason}
        ...
        <div className="flex justify-between mt-6">
          ...
          <Button buttonText="Submit" onClick={handleSubmit} type="primary" disabled={reason == ""} />
        </div>
      </div>
    </Modal>
  );
